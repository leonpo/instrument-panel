...
cockpit_local_point = {-1.55, 0.68, 0.0}
...
--Oxygen_Warning_Lamp				= CreateGauge()
--Oxygen_Warning_Lamp.arg_number	= 
--Oxygen_Warning_Lamp.input		= {0.0, 24.0}
--Oxygen_Warning_Lamp.output		= {0.0, 1.0}
--Oxygen_Warning_Lamp.controller	= controllers.Oxygen_Warning_Lamp
...
Fuel_Tank_Fuselage.arg_number	= 160
...
---------------------------------------------------
-- K-14 gunsight
sightRange				= CreateGauge()
sightRange.arg_number	= 36
sightRange.input		= {0.0, 1.0}
sightRange.output		= {0.0, 1.0}
sightRange.controller	= controllers.sightRange

K_14_Shake_Z				= CreateGauge()
K_14_Shake_Z.arg_number		= 188
K_14_Shake_Z.input			= {-1.0, 1.0}
K_14_Shake_Z.output			= {-0.9, 0.9}
K_14_Shake_Z.controller		= controllers.K_14_Shake_Z

K_14_Shake_Y				= CreateGauge()
K_14_Shake_Y.arg_number		= 187
K_14_Shake_Y.input			= {-1.0, 1.0}
K_14_Shake_Y.output			= {-0.5, 0.5}
K_14_Shake_Y.controller		= controllers.K_14_Shake_Y

-------------------------------------------------------
ThrottleTwistGrip				= CreateGauge()
ThrottleTwistGrip.arg_number	= 45
ThrottleTwistGrip.input			= {0.0, 1.0}
ThrottleTwistGrip.output		= {0.0, 1.0}
ThrottleTwistGrip.controller	= controllers.sightRange
...
Rocket_Counter						= CreateGauge()
Rocket_Counter.arg_number			= 77
Rocket_Counter.input				= {0.0, 1.0} 
Rocket_Counter.output				= {0.0, 1.0}
Rocket_Counter.controller			= controllers.Rocket_Counter
...
flashlight = 
{
	...
	angle		= math.rad(20),
	attenuation = {0,1,3,2},
	projection_texture = "flashlight.bmp",
}
